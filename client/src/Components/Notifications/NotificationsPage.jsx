...
import { FiBell, FiCheck, FiUser, FiUserPlus, FiFileText, FiStar, FiArrowLeft, FiChevronLeft, FiChevronRight } from 'react-icons/fi';
...
const NotificationsPage = () => {
  ...
  const renderNotificationActions = (notification) => {
    if (notification.type === 'INVITATION' && !notification.actionTaken) {
      return (
